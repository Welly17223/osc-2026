...
pub static mut TIMER_QUEUE: Option<BinaryHeap<Reverse<Box<TimerEntry>>>> = None;
...
impl Time {
    ...
    pub fn as_raw(&self) -> u64 {
        match self.unit {
            ...
            TimeUnit::MicroSec => self.time * get_sec() / 1000000,
...
pub fn add_timer<T>(delay: Time, callback: fn(*const u8), args: Option<Box<T>>, is_repeat: bool) {
    ...
    timer_queue.push(core::cmp::Reverse(Box::new(TimerEntry::new(
        callback,
